...
<head>
    ...
    <!-- Stylesheet
    ========================= -->
    <link rel="stylesheet" type="text/css" href="/bdadmin/login_css/vendor/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="/bdadmin/login_css/vendor/font-awesome/css/all.min.css">
    <link rel="stylesheet" type="text/css" href="/bdadmin/login_css/css/stylesheet.css">
</head>
<style>
    .sidebar .nav-item {
        position: relative;
...
<body>
    ...
    <div id="main-wrapper" class="oxyy-login-register">
        <div class="hero-wrap d-flex align-items-center h-100">
            ...
            <div class="hero-bg hero-bg-scroll" style="background-image:url('/bdadmin/arkaplan/b.jpg');"></div>
                            ...
                            <div class="container my-auto py-4 shadow-lg bg-white">
                                <div class="row">
                                    <div class="col-11 col-lg-11 mx-auto">
                                        ...
                                        <form action="{{ route('adminloginpost') }}" id="loginForm" method="post">
                                        @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control rounded-0" name="password" placeholder="Şifre">
                                            </div>
    ...
    <!-- Select2 -->
    <script src="/bdadmin/login_css/js/switcher.min.js"></script>
    <script src="/bdadmin/login_css/js/theme.js"></script>
    <script>
