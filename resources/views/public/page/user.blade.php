        ...
        <div class="row">
            <div class="col-12">
                <div class="aydinlatma-metni">
                    <h3 style="text-align: center;">BD Akademi Aydınlatma Metni</h3>
                     <br>
                        <strong>Veri Sorumlusu:</strong>BD Akademi Eğitim ve Teknoloji Ticaret Limited Şirketi
                        <strong> (“BD AKADEMİ”)</strong>
                    ...
                    <br><br>
                    <h4>2. Tarafımızca işlenen Kişisel Verileriniz ve Bunların İşlenme Amaçları</h4>
                    <br>
                        ...
                        <table class="table  " style="font-size: 16px; font-family: 'Montserrat', sans-serif; color: #666666; font-weight: 400; line-height: 24px; ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul style="list-style: circle;">
                                            <li>Satın almış olduğunuz eğitimlerde geçirmiş olduğunuz vakit bilgisi</li>
                                            <li>Hangi eğitimleri tamamladığınıza dair bilgiler</li>
                                            <li>Eğitim içerisinde sizlere verilen ödev/görevleri tamamlayıp,
                                                tamamlamadığınıza ilişkin bilgiler</li>
                                            <li>Eğitimler ve diğer öğrenciler ile etkileşimlerinize ait bilgiler</li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <ul style="list-style: circle;">
                                            <li>Satın almış olduğunuz eğitimlere ilişkin değerlendirme puanlarız</li>
                                            <li>Eğitimlere ilişkin yazmış olduğunuz yorumlar</li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th scope="row">Ödeme Bilgileriniz</th>
                                    <td>
                                        <ul style="list-style: circle;">
                                            <li>Satın almış olduğunuz eğitimlerin tutarı</li>
                                            <li>Ödeme yönteminiz</li>
                                        </ul>
                                    </td>
                                </tr>
                                ...
                                <td>
                                    <ul style="list-style: circle;">
                                        <li>Facebook veya başka bir üçüncü taraf platformu ya da hizmeti aracılığıyla
                                            ...
                                            cihazlarınızın fiziksel konumunu, cinsiyetinizi, doğum gününüzü ve arkadaş
                                            veya kişi listenizi toplayabiliriz.</li>
                    ...
                    BD Akademi olarak internet sitemiz üzerinden üye olmak ve eğitimlerimizden yararlanmak
                    istediğinizde yukarıda kategorize olarak belirttiğimiz kişisel verilerinizi aşağıdaki amaçlar
                    kapsamında işlemedikteyiz.
                    <br><br>
                    ...
                    <ul style="list-style: circle;">
                        ...
                        <li>Sizlere sunduğumuz hizmetleri geliştirebilmek, iş sürekliliğini sağlamak, yeni ürün ve
                            hizmetlere sunabilmek adına sizlerden geri bildirim alabilmek ve kendi personellerimizin
                            denetlenmesi </li>
                    ...
                    <h5>Müşteri İşlem Veri Kategorisine Ait Verilerinizi;</h5>
                    <ul style="list-style: circle;">
                        <li>Satın alınan eğitimlerimizin istatistiğinin tutulması, ürün ve hizmetlerimizin geliştirmesi
                            için analiz çalışmalarının yapılması</li>
                        <li>Kanuni yükümlülüklerimizi yerine getirebilmek (fatura kesilmesi gibi)</li>
                        <li>Talep ve şikayetlerinizin çözüme kavuşturulması</li>
                    </ul><br>
                    ...
                    <ul style="list-style: circle;">
                        ...
                        <li>Eğitim ve eğitmenlerimizin değerlendirilmesi</li>
                        <li>Satın aldığınız eğitimlere ilişkin bilgilendirme yapabilmek</li>
                   ...
                   BD Akademi olarak tarafımızca kredi kartı bilginiz işlenmemektedir. <br><br>
                    ...
                    <div class="table-responsive aydinlatma-tablo aydinlatma-border">
                        <table class="table " style="font-size: 16px; font-family: 'Montserrat', sans-serif; color: #666666; font-weight: 400; line-height: 24px; ">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">İnternet Sitesi
                                        Üzerinden Üye
                                        olunmak istendiğinde
                                        doldurulan form
                                        üzerinden</th>
                                    <td>Kimlik, İletişim, Farklı Platformlardaki
                                        Hesaplarınız Hakkında Bilgiler</td>
                                    <td>KVKK’nun 5. maddesinin (c) bendinde düzenlenmiş olan bir sözleşmenin
                                        ...
                                        veri işlemenin gerekli olması<br><br>
                                ...
                                <tr>
                                    ...
                                    <td>Kimlik, iletişim, sosyal medya
                                        bilgileri, İlgi Alanları</td>
                                    <td>KVKK’nun 5. maddesinin (c) bendinde düzenlenmiş olan bir sözleşmenin
                                        kurulması veya ifası ile doğrudan doğruya ilgili olması kaydıyla
                                        için veri işlemenin gerekli olması<br><br>KVKK’nun 5. maddesinin (f) bendinde
                                        düzenlenmiş olan ilgili kişinin
                                        temel hak ve özgürlüklerine zarar vermemek kaydıyla, veri sorumlusunun
                                        meşru menfaatleri için veri işlemesinin zorunlu olması</td>
                                ...
                                <tr>
                                    <th scope="row">İnternet Sitesi
                                        Üzerinden Eğitim
                                        Paketi Alınması</th>
                                    <td>Müşteri İşlem, Pazarlama, Eğitim,
                                        Ödeme Bilgileri</td>
                                    <td>KVKK’nun 5. maddesinin (c) bendinde düzenlenmiş olan bir sözleşmenin
                                        kurulması veya ifası ile doğrudan doğruya ilgili olması kaydıyla için
                                ...
                                <tr>
                                    <th scope="row">İnternet Sitesi
                                        Üzerinden Müşteri
                                        Şikâyet ve Taleplerinizi
                                        ilettiğiniz Form
                                        Aracılığı ile İşlediğimiz
                                        Verileriniz.</th>
                                ...
                                <tr>
                                    <th scope="row">Eğitimleri
                                        Değerlendirmek
                                        için kullanılan puan
                                        ve yorum sistemi
                                        üzerinden</th>
                                    <td>Müşteri İşlem, İşlem Güvenliği,
                                        Değerlendirme, Eğitim</td>
                                    <td>KVKK’nun 5. maddesinin (c) bendinde düzenlenmiş olan bir sözleşmenin
                                        kurulması veya ifası ile doğrudan doğruya ilgili olması kaydıyla için
                                        veri işlemenin gerekli olması
                                        <br><br>
                                ...
                                <tr>
                                    <th scope="row">Sunucularımıza
                                        eriştiğinizde
                                        otomatik olarak
                                        işlediğimiz verileriniz</th>
                    ...
                    tarayıcısı tarafından saklanmaktadır.
                    <br>
                    ...
                    <br>
                    BD Akademi tarafından çerezler vasıtası ile toplanan kişisel verileriniz bu Politika ve BD Akademi
                    tarafından yönetilen internet sitesi için hazırlanmış olan Çerez Politikası’nda belirtilen amaçlar
                    dışında kullanılmayacak olup, kişisel verileriniz KVKK’na aykırı bir şekilde işlenmeyecektir. Bu
                    hususta, çerezlerin işlevi, hangi tür çerezlerin kullanıldığı ve çerez kullanımımız ile ilgili
                    detaylı bilgi için lütfen BD Akademi tarafından Sitemiz için hazırlanmış olan Çerez Politikası’nı
                    inceleyiniz.<br><br>
                    <h4>
                    ...
                    avukatlarımız ile paylaşmaktayız.<br><br>
                    ...
                    <br>
                        Kişisel verilerinize ilişkin olarak KVKK’nın “ilgili kişinin haklarını düzenleyen” maddede
                        sayılan haklarınızla ilgili taleplerinizi, “Veri Sorumlusuna Başvuru Usul ve Esasları Hakkında
                        Tebliğe” uygun olarak Şirketimizin
                        .........................................................................................................................adresine
